...
Node
    ...
    Description
        Text
            In this package tensors are represented as elements of free associative polynomial algebras, 
        ...
        Text
            Another notation for tensors is @TO wordFormat@, which converts every decomposable tensor in the 
            ordered list of its factors. 
